				...
				@csrf
							...
							<div class="mb-3">
							  ...
							  <div class="mb-3">
								...
								<input id="image-uploadify" type="file"  name="video" accept="" multiple>
							  </div>
                            </div>
						   </div>
						   <div class="col-lg-4">
							<div class="border border-3 p-4 rounded">
                              <div class="row g-3">
								<div class="col-md-12">
									...
									<input type="" name="duration"  class="form-control" id="inputPrice" placeholder="00.00">
								  </div>
                                ...
                                <div class="form-check">
									<input class="form-check-input" type="checkbox" value="" name="editor" id="flexCheckDefault">
									<label class="form-check-label" for="flexCheckDefault">Edited by Cheif-Editor</label>
								</div>
								<div class="form-check">
									<input class="form-check-input" type="checkbox" name="publish" value="" id="flexCheckChecked" >
