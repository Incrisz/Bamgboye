...
<div class="page-wrapper">
			<div class="page-content">
				...
				<div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
					...
					<div class="ms-auto">
						<div class="btn-group">
						<div class="ms-auto"><a href="{{route('blog.create')}}" class="btn btn-primary radius-30 mt-2 mt-lg-0"><i class="bx bxs-plus-square"></i>Add New Blog</a></div>
				...
				<h6 class="mb-0 text-uppercase">Media Blog</h6>
				<hr/>
				<div class="card">
					<div class="card-body">
								...
								@foreach($blogs as $key=>$blog)
									...
									<td>{{ $key + 1 }}</td>
                                        ...
                                        <div class="recent-product-img">
													 <img src="{{ URL::asset('storage/blog/'.$blog->image) }}" alt="">
                                        ...
                                        <a href="{{ route('blog.show',$blog->id) }}" class="text-warning bg-light-warning border-0"><i class='bx bxs-show'></i></a>
										<a href="{{ route('blog.edit',$blog->id) }}" class="ms-4 text-primary bg-light-primary border-0"><i class='bx bxs-edit' ></i></a>

										<a href="javascript:;" onclick="deleteBlog({{ $blog->id }})" class="text-danger bg-light-danger border-0">
