...
<div class="page-wrapper">
			<div class="page-content">
				...
				<h6 class="mb-0 text-uppercase">  _CATEGORY</h6>
				<hr/>
				<div class="card">
					<div class="card-body">
							...
							<table id="example" class="table table-striped table-bordered">
								...
								@foreach($categories as $key=>$category)
									<tr>
										...
										<a href="{{ route('category.edit',$category->id) }}" class="ms-4 text-primary bg-light-primary border-0"><i class='bx bxs-edit' ></i></a>

                                        <a href="javascript:;" onclick="deleteCategory({{ $category->id }})"  class="text-danger bg-light-danger border-0"><i class='bx bxs-trash'></i></a>
